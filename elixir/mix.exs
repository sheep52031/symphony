    ...
    [
      ...
      test_coverage: [
        ...
        ignore_modules: [
          ...
          SymphonyElixir.Linear.Handoff,
          SymphonyElixir.Pi.TrackerBridge,
          SymphonyElixir.Pi.TrackerBridgeExtension,
          SymphonyElixir.Pi.TrackerBridgePlug,
          SymphonyElixir.SecretCommand,
